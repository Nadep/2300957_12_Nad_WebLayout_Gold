            ...
            >
                <Form style={{ display: "flex ", gap: "8px" }} onSubmit={handleSubmit} >
                    ...
                    <FormGroup style={{ width: "208px", height: "36px", padding: "9px 12px", borderRadius: "2px" }}>
                        ...
                        <Input id="kategori" name="select" type="select" placeholder="Masukan Kapasitas Mobil" value={category} onChange={(e) => setCategory(e.target.value)}>
                    ...
                    <FormGroup style={{ width: "208px", height: "36px", padding: "9px 12px", borderRadius: "2px" }}>
                        ...
                        <Input id="harga" name="select" type="select" placeholder="Masukan Harga Sewa Per Hari" value={price} onChange={(e) => setPrice(e.target.value)}>
                    ...
                    <FormGroup style={{ width: "208px", height: "36px", padding: "9px 12px", borderRadius: "2px" }}>
                        ...
                        <Input id="status" name="select" type="select" value={isRented} onChange={(e) => setIsRented(e.target.value)}>
                            <option>Disewa</option>
                        </Input>
                    </FormGroup>
                    <div style={{ display: " flex", alignItems: "center" }}>
                        <Button color="success" style={{ width: "92px", height: "36px", marginLeft: "8px" }} type="submit" onClick={() => {
